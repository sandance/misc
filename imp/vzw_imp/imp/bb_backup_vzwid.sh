...
usage()
{
	echo "$0 <studyname>  <postpde_path>  <pde_path> <od_acount> <ticketnum> <disk> <vol>"
        echo "-----------------------------------------------"
}
...
send_files_for_bb()
{
        ...
        rsync -avz  $postpde/output/{PackageODStudy,PackageClassifiedPoints}  nazmul@10.255.211.26:$bb_disk/$osticket/$studyname/OD/                                         #copy od study output, volume=static2/od or ibmlun2 

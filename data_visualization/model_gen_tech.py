...
def load_data(import_file):
	...
	for line in fp.readlines():
		...
		newline=str(curLine[1]) +' '+ str(curLine[5])
...
def histogram_plot(plotdata):
	...
	n, bins, patches = P.hist( [x,y,z], 10, weights=[w0, w1, w2], histtype='bar', color=['red', 'blue', 'green'], label=['lucent','nortel','motorolla'])
	P.xlabel('Percentage of CCC')
	P.ylabel('Number of Switches')
	P.title('Histogram of CCC')
	P.legend()
	P.show()
